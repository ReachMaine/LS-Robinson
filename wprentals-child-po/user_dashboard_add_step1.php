...
// Wp Estate Pack
/* Mods
  23Oct17 zig - disable new listing admin email
*/
...
//                    $term_meta['category_attach_id'] = '';
            ...
            rcapi_create_new_listing($new_user_id,$post_id,$submit_title,$property_description,$new_status,$prop_category_name,$prop_action_category_name,$property_city,$property_area,$guest_no,$property_admin_area,$property_country,'');
           ...
           $arguments=array(
            ...
            // zig, remove admin_email from line below, per instruction from developer to disable new listing submission
            wpestate_select_email_type(get_option(''),'new_listing_submission',$arguments);
