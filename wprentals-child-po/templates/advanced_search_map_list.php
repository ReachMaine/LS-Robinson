<?php
/* zig mods
  - only show advanced search if postmeta != 'no'
  - dont show rooms ddl,
  - size of Location Input box.
*/
...
?>
<?php $show_filter_area = get_post_meta($post->ID, 'show_filter_area', true);

if ($show_filter_area != 'no') { ?>
  <div id="advanced_search_map_list">
      <div class="advanced_search_map_list_container">
          ...
          if($search_type == 'oldtype' || $search_type=='newtype'){ ?>
              ...
              <div class="col-md-3 map_icon">
                  ...
                  if ($wpestate_autocomplete_use_list=='yes' && $show_adv_search_general=='no'){
                     print wprentals_location_custom_dropwdown($_REQUEST,esc_html__('Which Town?','wprentals'));
                  }else{
                      print '<input type="text"    id="search_location'.$wpestate_internal_search.'"      class="form-control" name="search_location" placeholder="'.esc_html__('Which Town?','wprentals').'" value="'.$search_location.'"  >';
                  }
          ...
          <?php /* zig xout <div class="col-md-3">
          <div class="col-md-3">
          ...
          <?php /* zig, changes here - default to vacation, strip out all */
          $categ_select_list = str_replace('<li role="presentation" data-value="all">All Types</li>', "", $categ_select_list); // zig - remove all Types      ?>
          <div class="col-md-3">
              <div class="dropdown form-control types_icon" id="categ_list" >
                  <div data-toggle="dropdown" id="adv_categ" class="filter_menu_trigger" data-value="vacation"> <?php  echo 'Vacation';?> <span class="caret caret_filter"></span> </div>
...
<?php } /* end $show_featured_area meta */ ?>
