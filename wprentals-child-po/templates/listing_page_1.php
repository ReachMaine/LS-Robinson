...
<div   itemscope itemtype="http://schema.org/RentAction" class="row content-fixed-listing listing_type_1">
    ...
    if ( $wpestate_options['content_class']=='col-md-12' || $wpestate_options['content_class']=='none'){
       ...
       print  $wpestate_options['content_class'];
    }?> ">
    ...
    <div class="single-content listing-content">
        ...
        <?php
            ...
            if($content!=''){
                ...
                print '<h4 class="panel-title-description">'.$wpestate_property_description_text.'</h4>';
        ...
        <div class="panel-wrapper" id="listing_price">
            <a class="panel-title" data-toggle="collapse" data-parent="#accordion_prop_addr" href="#collapseOne"> <span class="panel-title-arrow"></span>
                <?php if($wpestate_property_price_text!=''){
                    print $wpestate_property_price_text;
                } else{
        ...
        <div class="panel-wrapper">
            ...
            <a class="panel-title" data-toggle="collapse" data-parent="#accordion_prop_addr" href="#collapseTwo">  <span class="panel-title-arrow"></span>
                ...
                if($wpestate_property_adr_text!=''){
                    print $wpestate_property_adr_text;
                } else{
        ...
        <div class="panel-wrapper">
            ...
            if($wpestate_property_details_text=='') {
                ...
                print'<a class="panel-title"  id="listing_details" data-toggle="collapse" data-parent="#accordion_prop_addr" href="#collapseTree"><span class="panel-title-arrow"></span>'.$wpestate_property_details_text.'  </a>';
            }
            ?>
        ...
        <div class="panel-wrapper features_wrapper">
            ...
            if ( count( $feature_list_array )!=0 && !count( $feature_list_array )!=1 ){ //  if are features and ammenties
                if($wpestate_property_details_text ==''){
                    ...
                    print '<a class="panel-title" id="listing_ammenities" data-toggle="collapse" data-parent="#accordion_prop_addr" href="#collapseFour"><span class="panel-title-arrow"></span>'. $wpestate_property_details_text.'</a>';
                }
                ?>
        ...
        <div class="property_page_container google_map_type1">
            ...
            <div class="google_map_on_list_wrapper">
                ...
                <div id="google_map_on_list"
                    data-cur_lat="<?php print $wpestate_gmap_lat;?>"
                    data-cur_long="<?php print $wpestate_gmap_long ?>"
    ...
    <div class="
        ...
        if($wpestate_options['sidebar_class']=='' || $wpestate_options['sidebar_class']=='none' ){
            ...
            print $wpestate_options['sidebar_class'];
        }
        ?>
