...
<?php /* remove mobile booking form zig */ ?>
      ...
      <?php /* moved map - from here to sidebar */ ?>
    ...
    <div class="
        ...
        <?php /* zig remove non-mobile booking form
        if ( !wp_is_mobile() ) {
            get_template_part ('templates/booking_form_template');
        } */
        ?>
        <?php /* remove owner_area2  - zig */ ?>
        <?php /* move map to sidebar - zig */?>
        <div class="property_page_container google_map_type1">
            ...
            <div class="google_map_on_list_wrapper">
                <?php if( wprentals_get_option('wp_estate_use_openstreet_property','')=='no' ){ ?>
